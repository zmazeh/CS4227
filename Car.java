...
public int getDistanceBehind(); //gets distance of car closest behind it (without threading)
public int getDistanceInfront(); //gets distance of car closest infront of it (without threading)
